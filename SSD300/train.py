...
# Data parameters
data_folder = './annotations'  # folder with data files
...
def main():
    ...
    print(f"Training SSD300 for {epochs} epochs!")
    ...
    if checkpoint is None:
        ...
        optimizer = DemonAdam(
            params=[{'params': biases, 'lr': 2 * lr}, {'params': not_biases}], lr=lr, epochs=epochs, step_per_epoch=len(train_dataset) // 32, weight_decay=weight_decay, betas=(0.9, 0.999, 0.999), k=0, alpha=1)
