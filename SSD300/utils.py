...
device = get_device()
# Label map
label_map_raw = json.load(open('./annotations/label_map.json'))
# label_map = {entry["name"]: entry["id"] for entry in label_map_raw.items()}
label_map = {k: v for k, v in label_map_raw.items()}
